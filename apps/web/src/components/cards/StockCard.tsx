...
export const StockCard: React.FC<StockCardProps> = ({ data, isLoading = false }) => {
  // Loading state
  if (isLoading || !data) {
    return (
      <Card>
  ...
  return (
    <Card className="transition-all duration-300 hover:shadow-lg hover:scale-[1.02] bg-gradient-to-br from-white to-gray-50/30">
      {/* Header */}
      <div className="flex justify-between items-start mb-6">
        <div>
